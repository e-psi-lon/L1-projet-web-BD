INSERT INTO suggestions (user_id, suggestion_type, status, admin_notes, reviewed_by) VALUES
(1, 'author', 'pending', '', NULL),
(4, 'book', 'pending', '', NULL),
(5, 'author', 'approved', '', 1),
(9, 'chapter', 'approved', '', 1),
(8, 'author', 'reviewed', 'Veuillez vérifier la date de décès', 1),
