...
<div class="container">
    ...
    <div class="card">
        ...
        <ul>
            ...
            <li>Des comptes utilisateurs avec la possibilité de suggérer de nouveaux textes</li>
            <li>Des fonctionnalités de recherche puissantes sur l'ensemble du corpus</li>
            <li>Des fonctionnalités collaboratives pour enrichir la collection</li>
        </ul>
    </div>
</div>
